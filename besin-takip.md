...
- Veri: IndexedDB şema **sürüm 5** — `suKayitlari`, `ozelHareketler`, `antrenmanGunlugu`, `favoriAntrenmanlar` depoları; hepsi JSON yedeğe dahil ve doğrulanıyor (`js/backup.js`).
