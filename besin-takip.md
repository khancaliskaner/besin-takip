...
### 6.3 İsteğe bağlı (v2)
- ~~Su takibi~~ (2026-09-22 eklendi, bkz. 6.4), ~~kilo takibi~~ (2026-09-22 eklendi, bkz. 6.6; ölçü/vücut ölçümleri kapsam dışı bırakıldı), ~~aralıklı oruç zamanlayıcı~~, ~~haftalık PDF/yazdır raporu~~, ~~besin karşılaştırma~~ (üçü de 2026-09-22 eklendi, bkz. 6.7), barkod (yok, çevrimdışı olduğu için bilinçli olarak atlandı — bkz. 6.7).
...
Bölüm 6.3'teki v2 listesinden **barkod hariç** kalan üç istek eklendi. Barkod bilinçli olarak atlandı: kamera erişimi çevrimdışı çalışsa bile ürün/barkod eşleştirmesi genelde çevrimiçi bir veritabanı gerektirir — bu, uygulamanın "internet, hesap, sunucu, bulut gerekmez" çekirdek kuralıyla çelişir (bölüm 2).
