...
### 6.3 İsteğe bağlı (v2)
- ~~Su takibi~~ (2026-09-22 eklendi, bkz. 6.4), kilo/ölçü takibi, aralıklı oruç zamanlayıcı, haftalık PDF/yazdır raporu, barkod (yok, çevrimdışı olduğu için atla), besin karşılaştırma.
