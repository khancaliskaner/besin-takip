...
4. **Kalıcı hafıza + hafif + bağımsız** — Veriler bilgisayarda saklanır; internet, hesap, sunucu, bulut gerekmez; program ağır olmaz.
   > **Tek, dar, kullanıcı onaylı istisna** (2026-09-22): Barkod özelliğinde, kullanıcı barkod bulunamadığında açıkça "İnternet gerekir" düğmesine tıklarsa yalnızca barkod numarası Open Food Facts'e gönderilir. Program bunun dışında hiçbir zaman, hiçbir veriyi otomatik olarak internete göndermez. Bkz. 6.8.
